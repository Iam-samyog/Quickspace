  ...
  return (
    <>
      <div className="container mx-auto  px-4 py-8 max-w-[1350px]">
        ...
        <div className='relative  w-full lg:w-1/2 h-[400px] md:h-[500px] lg:h-[700px] hidden xl:block'>
    ...
    <div className="border-t border-gray-200">
      {faqItems.map((item, index) => (
        <div key={index} className="border-b pb-4 border-gray-200">
          ...
          >
            <h3 className="text-lg md:text-[21px] font-medium text-gray-900 primary-font tracking-[-1px]">
              {item.question}
            </h3>
            {openIndex === index ? (
